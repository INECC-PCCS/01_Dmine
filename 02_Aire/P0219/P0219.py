...
M = Meta
M.ClaveParametro = 'P0219'
M.NombreParametro = 'Emisiones anuales PM25'
M.DescParam = 'Partículas suspendidas menores a 2.5 micras'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de PM25 para los municipios que componen ' \
               'cada ciudad del SUN' \
