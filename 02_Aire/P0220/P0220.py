...
M = Meta
M.ClaveParametro = 'P0220'
M.NombreParametro = 'Emisiones anuales SO2'
M.DescParam = 'Dióxido de azufre'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de SO2 para los municipios que componen ' \
               'cada ciudad del SUN' \
