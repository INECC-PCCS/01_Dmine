...
M = Meta
M.ClaveParametro = 'P0225'
M.NombreParametro = 'Emisiones anuales de CN'
M.DescParam = 'Carbono Negro'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de Carbono Negro para los municipios que componen ' \
               'cada ciudad del SUN' \
