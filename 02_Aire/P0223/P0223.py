...
M = Meta
M.ClaveParametro = 'P0223'
M.NombreParametro = 'Emisiones anuales de COV'
M.DescParam = 'Compuestos orgánicos volátiles'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de COV para los municipios que componen ' \
               'cada ciudad del SUN' \
