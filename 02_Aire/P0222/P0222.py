...
M = Meta
M.ClaveParametro = 'P0222'
M.NombreParametro = 'Emisiones anuales de NOX'
M.DescParam = 'Óxidos de nitrógeno'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de NOX para los municipios que componen ' \
               'cada ciudad del SUN' \
