...
M = Meta
M.ClaveParametro = 'P0224'
M.NombreParametro = 'Emisiones anuales de NH3'
M.DescParam = 'Amoníaco'
M.UnidadesParam = 'ton'
...
M.ActDatos = '2008'
M.Agregacion = 'Se sumó la cantidad de emisiones anuales de NH3 para los municipios que componen ' \
               'cada ciudad del SUN' \
