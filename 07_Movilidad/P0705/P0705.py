...
M = Meta
M.ClaveParametro = 'P0705'
M.NombreParametro = 'Vialidades con banqueta'
M.DescParam = 'Numero de manzanas segun disponibilidad de banqueta en sus vialidades'
M.UnidadesParam = 'Numero de manzanas'
M.TituloParametro = 'MBanqueta'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2014'
M.TipoInt = 1
...
M.ContenidoHojaDatos = 'Manzanas por municipio segun disponibilidad de banqueta en sus vialidades'
M.ClaveDataset = 'CLEU'
M.ActDatos = '2014'
M.Agregacion = 'Se clasificó el total de manzanas por municipio segun la disponibilidad de banqueta en alguna de ' \
               'sus vialidades. Se agregaron a una sola columna las manzanas en donde alguna o todas sus ' \
               'vialidades disponen de banqueta. Para la agregación de datos' \
...
bt = 'Banqueta en todas las vialidades'
ba = 'Banqueta en alguna vialidad'
par_dataset = dataset[bt]+dataset[ba]
