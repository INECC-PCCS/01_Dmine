...
M = Meta
M.ClaveParametro = 'P0703'
M.NombreParametro = 'Restricción al paso de peatones'
M.DescParam = 'Numero de manzanas segun restricción del paso a peatones'
M.UnidadesParam = 'Numero de manzanas'
M.TituloParametro = 'MRPpeato'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2014'
M.TipoInt = 1
...
M.ContenidoHojaDatos = 'Numero de manzanas por municipio segun restricción del paso a peatones en alguna de sus' \
                       'vialidades'
M.ClaveDataset = 'CLEU'
M.ActDatos = '2014'
M.Agregacion = 'Se clasificó el total de manzanas por municipio de acuerdo con la restriccion al paso de peatones' \
               'en sus vialidades. Se agregaron a una sola columna las manzanas en donde alguna o todas las ' \
               'vialidades de una manzana tienen restriccion al paso de peatones. Para la agregación de datos' \
...
tv = 'RPPeatones Todas las vialidades'
av = 'RPPeatones Alguna vialidad'
par_dataset = dataset[tv]+dataset[av]
