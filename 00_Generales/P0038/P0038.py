...
M = Meta
M.ClaveParametro = 'P0038'
M.NombreParametro = 'Coeficiente de Gini'
M.DescParam = 'Coeficiente de Gini'
M.UnidadesParam = 'Coeficiente'
M.TituloParametro = 'GINI'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2014'
...
M.nomarchivodataset = 'GINI'
M.extarchivodataset = 'xlsx'
M.ContenidoHojaDatos = ''
M.ClaveDataset = 'IMCO'
M.ActDatos = '2014'
M.Agregacion = 'Se promedió el coeficiente de GINI para los municipios que ' \
