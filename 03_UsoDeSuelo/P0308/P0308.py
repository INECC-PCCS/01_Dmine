...
M = Meta
M.ClaveParametro = 'P0308'
M.NombreParametro = 'Areas verdes per capita'
M.DescParam = 'Promedio de metros cuadrados de area verde por habitante'
M.UnidadesParam = 'M²'
M.TituloParametro = 'AVPC'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2014'
...
M.nomarchivodataset = 'AVPC'
M.extarchivodataset = 'xlsx'
M.ContenidoHojaDatos = ''
M.ClaveDataset = 'IMCO'
M.ActDatos = '2014'
M.Agregacion = 'Se promediaron los metros cuadrados per capita para los municipios que ' \
