...
M = Meta
M.ClaveParametro = 'P1013'
M.NombreParametro = 'Número de rellenos sanitarios'
M.DescParam = 'Número de rellenos sanitarios dentro de los municipios en los que se ubica una Ciudad'
...
M.ContenidoHojaDatos = 'Nombre y ubicacion de rellenos sanitarios'
M.ClaveDataset = 'INEGI'
M.ActDatos = '2018'
M.Agregacion = 'Se contó el numero de rellenos sanitarios dentro de cada municipio. Luego se sumó el numero de ' \
               'rellenos sanitarios dentro de los municipios de cada ciudad'
