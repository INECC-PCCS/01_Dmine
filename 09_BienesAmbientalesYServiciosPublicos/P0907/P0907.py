...
NombreParametro = 'Superficie Acuicola'
TituloParametro = 'SF_ACUICOLA'          # Para nombrar la columna del parametro
ContenidoDatos = 'Superficie acuicola por clave SUN'   # Contenido de la hoja 'Datos'
Notas = ''
...
DescVarIntegridad = 'La variable de integridad para esta Dataset es el porcentaje variables que cuentan con informacion' \
                    'para cada municipio'
DescParam = 'Superficie acuicola (Kilometros Cuadrados)'
...
# Elegir columna de area acuifera y reconvertir a dataset
...
Columnas = (variables_SUN + variables_dataset)
OrdenColumnas = Columnas[:len(Columnas)-1]
