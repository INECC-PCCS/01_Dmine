...
ClaveParametro = 'P0603'
NombreParametro = 'Viviendas con calentador de agua (boiler)'
DescParam = 'Porcentaje de viviendas particulares habitadas con calentador de agua (boiler)'
UnidadesParam = 'Porcentaje'
TituloParametro = 'VIV_BOILER'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'
...
dataset = dataset[dataset['Tipo de equipamiento'].str.contains('Boiler o calentador de agua')]

colummas = ['Dispone_de_Equipamiento']                 # Columnas que se utilizan para construir el parámetro
dataset = dataset[colummas]
par_dataset = dataset
par_dataset = par_dataset.rename(columns = {'Dispone_de_Equipamiento' : ClaveParametro})
