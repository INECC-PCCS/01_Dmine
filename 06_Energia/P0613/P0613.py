...
ClaveParametro = 'P0613'
NombreParametro = 'Viviendas que utilizan gas para cocinar'
DescParam = 'Porcentaje de viviendas particulares habitadas que utilizan gas para cocinar'
UnidadesParam = 'Porcentaje'
TituloParametro = 'VIV_GAS'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'
...
ClaveDataset = 'EI2015'
ActDatos = '2015'
Agregacion = 'Promedio del porcentaje de viviendas particulares habitadas que utilizan gas para cocinar en los ' \
             'municipios que componen una Ciudad del SUN. En la agregación de datos municipales a ciudades del SUN ' \
             'se han excluido los Municipos en los que la muestra de la Encuesta Intercensal fue clasificada como ' \
             'insuficiente.'
...
# Generar datasets para parámetro y Variable de Integridad
dataset = dataset[~dataset['Municipio'].str.contains('\*\*')]   # Excluir municipios con ** muestra insuficiente
colummas = ['Cocina_con_Gas']
dataset = dataset[colummas]
par_dataset = dataset['Cocina_con_Gas']                       # Construccion del Parámetro
