...
ClaveParametro = 'P0612'
NombreParametro = 'Viviendas que utilizan leña o carbón para cocinar, que disponen de estufa o fogón con chimenea'
DescParam = 'Porcentaje de viviendas que utilizan leña o o carbón para cocinar, que disponen de estufa o fogón ' \
            'con chimenea'
UnidadesParam = 'Porcentaje'
TituloParametro = 'VIV_CARB_CHIM'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'
DescVarIntegridad = 'La variable de integridad municipal para este Dataset es binaria: \n' \
                    '1 =  El municipio cuenta con informacion \n0 = El municipio no cuenta con información'

# Descripciones del proceso de Minería
nomarchivodataset = '09'
...
ClaveDataset = 'EI2015'
ActDatos = '2015'
Agregacion = 'Promedio del porcentaje de viviendas que utilizan leña o carbón para cocinar, que disponen de estufa o ' \
             'fogón con chimenea en los municipios que componen una Ciudad del SUN. En la agregación de datos ' \
...
colummas = ['Dispone_de_estufa_o_fogon_con_chimenea']
dataset = dataset[colummas]
par_dataset = dataset['Dispone_de_estufa_o_fogon_con_chimenea']                      # Construccion del Parámetro
