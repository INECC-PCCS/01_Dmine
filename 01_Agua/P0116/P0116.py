...
ClaveParametro = 'P0116'
DescParam = 'Rehabilitación de Tubería (%). Capacidad del Organismo Operador para mantener actualizada la red de ' \
            'agua, calculado por el PIGOO como el cociente resultante de dividir la Longitud de la tubería ' \
            'rehabilitada entre la longitud total de la tubería de distribución. Para la agregación a nivel Clave ' \
            'del SUN se calculó el promedio de rehabilitación para los municipios que componen la ciudad.'
UnidadesParam = 'Porcentaje'
NombreParametro = 'Rehabilitación de Tubería'
TituloParametro = 'REHAB_TUB'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'

# Descripciones del proceso de Minería
ContenidoHojaDatos = 'Datos de Rehabilitacion de Tubería disponibles de 2002 a 2015'
ClaveDataset = 'Pigoo'
...
dataset = pd.read_excel(DirFuente + r'\{}.xlsx'.format(ClaveDataset),
                        sheetname="Rehabilitación de tubería  (%)", dtype={'CVE_MUN': str})
