...
M.nomarchivodataset = 'P0105'
M.extarchivodataset = 'xlsx'
M.ContenidoHojaDatos = 'Acuiferos disponibles por municipio para las ciudades del SUN, años 2011 a 2015'
M.ClaveDataset = 'CONAGUA'
M.ActDatos = '2017'
M.Agregacion = 'Se prometió el valor del volumen disponible en acuiferos ubicados en los municipios ' \
               'que componen cada ciudad del SUN y que son accesibles a la mancha urbana de cada ciudad'
