...
ClaveParametro = 'P0115'
DescParam = 'Pérdidas por longitud de red (m³/km), calculado como el cociente resultante de dividir la diferencia del ' \
            'Volumen Anual Producido menos el volumen Volumen Anual Consumido entre la Longitud de la ' \
            'Red de Distribución. Para la agregación a nivel Clave del SUN se calculó el promedio de pérdidas para ' \
            'los municipios que componen la ciudad.'
UnidadesParam = 'm³/km'
NombreParametro = 'Pérdidas por Longitud de Red'
TituloParametro = 'PLR'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'

# Descripciones del proceso de Minería
ContenidoHojaDatos = 'Datos de Perdidas por longitud de la red disponibles de 2002 a 2015'
ClaveDataset = 'Pigoo'
...
dataset = pd.read_excel(DirFuente + r'\{}.xlsx'.format(ClaveDataset),
                        sheetname="Perdidas_por_long_red", dtype={'CVE_MUN': str})
