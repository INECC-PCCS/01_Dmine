...
DescParam = 'Dotación (Litros / Hora / Día: Estimación de la cantidad de agua asignada de acuerdo con la extracción' \
            'total. Estimada por el PIGOO como el cociente resultante de dividir el Volumen Anual de Agua producido ' \
            'multiplicado por 1000 entre el número de habitantes multiplicado por 365'
UnidadesParam = 'l/h/d'
NombreParametro = 'Dotación'
TituloParametro = 'DOTACION'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'

# Descripciones del proceso de Minería
ContenidoHojaDatos = 'Datos de estimacion de Dotacion disponibles de 2002 a 2015'
ClaveDataset = 'Pigoo'
...
dataset = pd.read_excel(DirFuente + r'\{}.xlsx'.format(ClaveDataset),
                        sheetname="Dotacion", dtype={'CVE_MUN': str})
