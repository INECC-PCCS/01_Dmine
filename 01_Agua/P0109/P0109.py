...
M = Meta
M.ClaveParametro = 'P0109'
M.NombreParametro = 'Sólidos Disueltos Totales'
M.DescParam = 'Datos de monitoreo de Sólidos Disueltos Totales'
M.UnidadesParam = 'mg/l'
M.TituloParametro = 'SDT'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2017'
...
M.nomarchivodataset = 'P0109'
M.extarchivodataset = 'xlsx'
M.ContenidoHojaDatos = 'Estaciones de monitoreo y datos de Solidos Disueltos Totales en mg/l'
M.ClaveDataset = 'CONAGUA'
M.ActDatos = '2017'
M.Agregacion = 'Se prometió el valor de SDT para las estaciones de monitorieo que existen en los municipios ' \
