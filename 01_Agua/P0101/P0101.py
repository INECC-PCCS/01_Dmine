...
ClaveParametro = 'P0101'
NombreParametro = 'Porcentaje de viviendas con agua entubada'
DescParam = 'Porcentaje de viviendas particulares que disponen de agua entubada dentro del predio o vivienda'
UnidadesParam = 'Porcentaje'
TituloParametro = 'VIV_AGUA'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'
...
ClaveDataset = 'EI2015'
ActDatos = '2015'
Agregacion = 'Promedio del porcentaje de viviendas que cuentan con el servicio de agua entubada en los ' \
             'municipios que componen una Ciudad del SUN. En la agregación de datos municipales a ciudades del SUN ' \
             'se han excluido los Municipos en los que la muestra de la Encuesta Intercensal fue ' \
...
colummas = ['Entubada_Total']                 # Culumnas que se utilizan para construir el parámetro
dataset = dataset[colummas]
par_dataset = dataset
par_dataset = par_dataset.rename(columns = {'Entubada_Total' : ClaveParametro})
