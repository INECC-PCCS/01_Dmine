...
ClaveParametro = 'P0118'
DescParam = 'Porcentaje de Cobertura de Agua Potable Reportada: Porcentaje de la población que cuenta con servicio ' \
            'de agua potable, calculado por PIGOO como el cociente resultante de dividir el producto del número ' \
            'de total tomas registradas multiplicado por el numero de habitantes por casa, dividido entre el ' \
            'número de habitantes. Para la agregación a nivel Clave del SUN se calculó el promedio de cobertura para ' \
            'los municipios que componen la ciudad.'
UnidadesParam = 'Porcentaje'
NombreParametro = 'Cobertura de Agua Potable'
TituloParametro = 'AGUA_POTABLE'                              # Para nombrar la columna del parametro
PeriodoParam = '2015'

# Descripciones del proceso de Minería
ContenidoHojaDatos = 'Cobertura de agua potable. Datos disponibles de 2002 a 2015'
ClaveDataset = 'Pigoo'
...
dataset = pd.read_excel(DirFuente + r'\{}.xlsx'.format(ClaveDataset),
                        sheetname="Cobertura_Agua_potable", dtype={'CVE_MUN': str})
