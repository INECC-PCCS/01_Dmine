...
M = Meta
M.ClaveParametro = 'P9901'
M.NombreParametro = 'Derechohabientes y Personal Médico'
M.DescParam = 'Número de derechohabientes, y númerode personal medico por institución'
M.UnidadesParam = 'Personas'
M.TituloParametro = 'NDPM'                              # Para nombrar la columna del parametro
M.PeriodoParam = '2015'
...
M.nomarchivodataset = 'Derechohab'
M.extarchivodataset = 'xlsx'
M.ContenidoHojaDatos = 'Número de derechohabientes, y númerode personal medico por institución'
...
var1 = 'Población derechohabiente'
